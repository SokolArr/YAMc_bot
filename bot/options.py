...
/link - `дай ссылку`  - вернет 🔗 ссылку на плейлист \n\
/create\_pl - `создай плейлист` - ✅ создаст плейлист \n\
/drop\_pl - `удали плейлист` - ❌ удалит плейлист"
...
/link - `"+ self.bot_tag + " дай ссылку`  - вернет 🔗 ссылку на плейлист \n\
/create\_pl - `"+ self.bot_tag + " ✅ создай плейлист` - создаст плейлист \n\
/drop\_pl - `"+ self.bot_tag + " ❌ удали плейлист` - удалит плейлист"
            return string
